...
function UseSelectCard({ control, name, label, options, type = "radio", dot = false }) {
    // type = radio || checkbox
    ...
    return (
        <Controller
            ...
            render={({ field, fieldState: { error } }) => (
                <>
                    <div className="text-sm mb-0.5 w-fit">{label}</div>
                            ...
                            return (
                                ...
                                >
                                    <input
                                        ...
                                        onClick={isRadio ? handleClick : undefined}
                                    />
