                ...
                <div className={`${showDev ? "block" : "hidden"}`}>
                    ...
                    <div className="h-fit w-fit bg-red-500 p-4 fixed z-100 m-4 right-0 top-51 rounded-lg font-bold text-white">
                        ...
                        <ul className="ps-4 list-decimal">
                            ...
                            <li>หน้า admin เมนู ตรวจสอบการ bid เมื่อมีผู้ชนะให้แสดงข้อมูล ผู้ซื้อ - ผู้ขาย ให้ admin เห็น</li>

                            <li>1 เมื่อผู้ชื้อชะรัเงินแล้ว ผู้ขายเห็นหน้า /user/checkout/ เป็นรายละเอียดของผู้ซื้อ เปลี่ยนจากปุ่ม ชำระเป็น ระบุเลขใบเสร็จการจัดส่ง</li>
